...
function NavBarDesktop() {
  return (
    <div className="sticky top-0 bg-black text-[20px] font-bold hidden items-center justify-end p-[20px] flex-row gap-[40px] text-orange-500 lg:flex">
      ...
      <form className="flex border-[2px] rounded-[0] border-orange-900 has-[:focus]:border-orange-500 py-[5px] pl-[10px] pr-[10px]">
        <input
      ...
      <a
        href="./myPortfolio"
        className="flex justify-center items-center gap-[7px] border-orange-500 border-[2px] px-[15px] py-[5px] rounded-[0px] hover:bg-orange-500 hover:text-black"
      >
        My portfoLIO
      </a>
      {/* <a
      ...
      <a
        href="./login"
        className="border-orange-500 border-[2px] px-[15px] py-[5px] rounded-[0px] hover:bg-orange-500 hover:text-black"
      >
        Login
      </a>
    </div>
