    ...
    <div className="lg:hidden">
      <div className=" sticky top-0 bg-black text-[10px] font-bold items-center justify-between flex p-[15px] flex-row gap-[40px] text-orange-500">
        ...
        {close ? (
          ...
          <div className="flex justify-center items-center text-[15px] gap-[15px] cursor-pointer">
            <a href="./new" className="underline underline-offset-[5px]">
              My portfoLIO
            </a>
            {/* <a href="./about" className="underline underline-offset-[5px]">About</a> */}
            <a href="./login" className="underline underline-offset-[5px]">
              Login
            </a>
      ...
      <form className="flex border-[1px] rounded-full border-orange-900 has-[:focus]:border-orange-500 py-[5px] pl-[20px] pr-[10px] mx-[12px] mt-[10px]">
        <input
          placeholder="Search portfoLIOs with email"
          className="text-orange-500 placeholder:text-gray-400 placeholder:text-[13px] w-full placeholder:font-light text-[15px]  bg-transparent border-0  focus:outline-none"
        />
